...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('add', app($dataType->model_name))
            <a href="{{ route('voyager.'.$dataType->slug.'.create') }}" class="btn btn-success btn-sm">
        ...
        @can('edit', app($dataType->model_name))
            @if(!empty($dataType->order_column) && !empty($dataType->order_display_column))
                <a href="{{ route('voyager.'.$dataType->slug.'.order') }}" class="btn btn-primary btn-sm">
        ...
        <a href="#" class="btn btn-primary btn-sm" onclick="micontactos()">
            <i class="voyager-plus"></i> <span>Actualizar Contactos</span>
        </a>
    </div>
@stop
...
@section('javascript')
    ...
    <script>
        ...
        function micontactos(){
            // $("#mibtn").hide()
            // toastr.info("Error removing file.");
            axios.post("{{ env('APP_BOT') }}/contactos" , {
                nombre: "{{ $miwhats->slug }}",
                codigo: "{{ $miwhats->codigo }}",
                user_id: "{{ Auth::user()->id }}",
                user: "{{ $miuser->name }}"
            })
            location.href = "/admin/whatsapps/{{ $miwhats->id }}"
        }

...
@section('page_header')
    <div class="container-fluid">
        ...
        <a href="/admin/plantillas" class="btn btn-dark btn-sm">
            <i class="voyager-list"></i> <span>Plantillas</span>
        </a>
        <a href="/admin/whatsapps" class="btn btn-dark btn-sm">
            <i class="voyager-list"></i> <span>Whatsapps</span>
        </a>
    </div>
@stop
